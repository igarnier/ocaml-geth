...
sig
  ...
  val estimate_gas : uri:string -> transaction:Tx.t -> at_time:time -> int
...
sig
  ...
  val send_contract_and_get_receipt : uri:string -> src:Address.t -> data:Bitstr.Hex.t -> gas:Z.t -> unit -> Tx.receipt Lwt.t
end
